...
def generate_lists_of_songs(sp,artist):
    ...
    recommendations = sp.recommendations(seed_artists=[artist_uri], limit=25)
...
token=SpotifyOAuth(client_id=CLIENT_ID,client_secret=SECRET,redirect_uri=REDIRECT_URI, scope=SCOPE,username=USERNAME)
...
for artist in artists_list:
    ...
    sp.user_playlist_add_tracks(user=USERNAME(sp), playlist_id=playlist, tracks=list_of_songs)
print('done')
